...
input_root = '../optimize/dataset-resize'
output_root = './output'
...
val_loader = torch.utils.data.DataLoader(dataset=val_dataset, batch_size=batch_size, shuffle=True, num_workers=6)
...
criterion = lossfuc.DiceLoss(weight=np.array([0.9991,0.0009]))
